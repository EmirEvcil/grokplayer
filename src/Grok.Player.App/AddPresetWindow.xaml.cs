...
public sealed partial class AddPresetWindow : Window
{
    ...
    public AddPresetWindow(nint owner, bool topmost)
    {
        _owner = owner;
        InitializeComponent();
    ...
    private static bool IsInteractive(object? source)
    {
        ...
        {
            if (current is Button or TextBox or Slider or Thumb)
            {
                return true;
            }
        }
